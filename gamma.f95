...
!    utilizando la definicion del producto infinito de Euler
!-----------------------------------
!
!    Codificación del texto: UTF8
!    Compiladores probados: GNU Fortran (Xubuntu Linux) 7.4.0
!    Instrucciones de compilación: no requiere nada mas
!    gfortran  -Wall -pedantic -std=f95 -o gamma.e gamma.f95
!    Copyright (C) 2020
!    E.A. López
!    eladolfos@gmail.com
!
...
!   2. Definir: variables del problema y auxiliares
        ...
        real(8) :: y
        complex(8) :: z, result
!   3. Definir: la funcion Gamma_Euler 
